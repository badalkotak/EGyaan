...
echo "<b>$usr</b>";
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <?php
          include("dbcon.php");
          $result1 = mysqli_query($con,"SELECT COUNT(ResultId) FROM `Result` WHERE `BatchId`='$br'");
...
error_reporting(0);
$i=0;
$result = mysqli_query($con,"SELECT * FROM Result where BatchId='$br'");
while($r_row = mysqli_fetch_array($result))
{
$r_uid=$r_row['ResultId'];
$CourseId=$r_row['CourseId'];
$getCname=mysqli_query($con,"Select CourseName From Course Where CourseId='$CourseId'");
while($crow=mysqli_fetch_array($getCname))
{
...
$i++;
$get_mks=mysqli_query($con,"SELECT Marks FROM StudentMarks WHERE ResultId='$r_uid' AND StudentId='$s_uid'");
