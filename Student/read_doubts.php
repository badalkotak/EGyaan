      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="doubts.php"><i class="fa fa-plus"></i> <span>Ask Doubt</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
              </aside>
...
$result = mysqli_query($con,"SELECT * FROM `StudentCourseRegistration` WHERE `StudentId`='$sid'");
while($row = mysqli_fetch_array($result))
{
  $cuid=$row['CourseId'];
  $i=0;
  $db_row="";
  $course_name=mysqli_query($con,"SELECT * FROM `Course` WHERE `CourseId`='$cuid'");
...
echo '<div class="col-md-12">
              <div class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">';
                  echo "<h3 class=box-title>$course</h3>";
...
<tbody>';
            $doubt=mysqli_query($con,"SELECT * FROM `Doubt` WHERE `CourseId`='$cuid'");
        while($db_row=mysqli_fetch_array($doubt)){
          $title=$db_row['Question'];$id=$db_row['Doubtid'];$ans=$db_row['Answer'];
      $i++;
  echo "<tr>";
echo "<td>";
echo $i;
