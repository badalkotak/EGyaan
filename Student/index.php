    ...
    <div class="full-content-center">
      <div class="login-wrap animated flipInX">
        <div class="login-block">
          ...
          Student Login<br><br>
          <form role="form" action="Login_form.php">
                            <div class="form-group login-input">
<select class="tb5" name="menu1" id="branch">
<?php
include("dbcon.php");
...
?>
          ...
          <i>Branch: Information Technology<br>Username: badalkotak@gmail.com</i><br><i>Password: bk123</i>
        </div>
      </div>
