      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="submission.php"><image src="../Resources/icons/homework.png" height=100 width=88><br><h4>Submission
	      </a></center>
            </div>
            <div class="col-md-3 col-sm=6 col-xs-6">
          ...
          <div class="row">
            <div class="col-md-3 col-sm=6 col-xs-6">
              <td><center><a href="view_ans_doubts.php"><image src="../Resources/icons/hands.png" height=100 width=88><br><h4>Doubts
	      </a></td>
            </div>
            <div class="col-md-3 col-sm=6 col-xs-6">
              <td><center><a href="branch_timetable.php"><image src="../Resources/icons/schedule.png" height=100 width=88><br><h4>Timetable
	      </a></td>
            </div>
