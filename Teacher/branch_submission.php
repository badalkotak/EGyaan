    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <form action="detailed_submission.php" method="post">
          <label>Select Course</label>
          <select name="menu1">
          <?php
          include("dbcon.php");
          $r=mysqli_query($con,"Select * from course_teacher where email='$user'");
          while($row=mysqli_fetch_array($r))
          {
            $course=$row['course'];
            $uid=$row['uid'];
            echo "<option value=$uid>$course</option>";
          }
          echo "</select>";
          echo "<button type=submit class=btn btn-default>Select</button>";
