    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
           <form action=add_ans.php role="form" method="post" enctype="multipart/form-data">
...
$doubt=$_REQUEST['give'];
$d=urldecode($doubt);
$result= mysqli_query($con,"SELECT * FROM `Doubt` WHERE `Doubtid`='$doubt'");
...
echo $quest;echo "<br>";
echo "<textarea rows=5 cols=100 id=comment name=ans placeholder= Answer>$a</textarea>";
echo "<div class=form-group>";
echo "<label for=file>Select File:</label>";
echo "<input type=file class=tb5 name=file>(Optional)<br>";
echo "</div>";
if($student_file!="")
{
...
$db=urlencode($d);
echo "<button type=submit class=btn btn-success name=quest value=$doubt >Done</button>";
