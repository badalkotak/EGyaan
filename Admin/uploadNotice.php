...
<html>
  <head>
    ...
    <title>Add Branches/Standards</title>
        ...
        <section class="content">
         ...
         <div class="col-md-3">
              <div class="box box-default collapsed-box box-solid">
                ...
                <div class="box-body">
                <form action=upload_file_notice.php role="form" method="post" enctype="multipart/form-data">
                  <label for="file">Select File:</label>
<input type="file" name="file" size="50" />(OPTIONAL)
                      <button type="submit" class="btn btn-success">Upload</button>
</form>
                </div><!-- /.box-body -->
              </div><!-- /.box --><br><!-- /.col -->
              <a href="Read_notice.php"><button type="submit" class="btn btn-success">Skip</button></a>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
      <!-- Main Footer -->
