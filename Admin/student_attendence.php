  ...
  <body class="hold-transition skin-yellow-light sidebar-mini">
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="view_attendence.php"><i class="fa fa-table"></i> <span>Sort by Course</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <label for="menu1">Select Student:</label>
<select class="tb5" name="menu1" onchange="showAttendance(this.value)">
  <option value="">Select Student..</option>
<?php
include("dbcon.php");
$result = mysqli_query($con,"SELECT * FROM Student ORDER BY(StudentId)");
...
$uid=$row['StudentId'];
//$email=$row['semail'];
$Batch=mysqli_query($con,"SELECT BatchName FROM Batch WHERE BatchId='$bname'");
while($brow=mysqli_fetch_array($Batch))
{
$bname=$brow['BatchName'];
}
echo "<option value=$uid>$name- $bname</option>";
}
?>
</select>
<div id="txtHint"></div>
...
function showAttendance(str) {
  ...
  xhttp.open("GET", "view_course_stud.php?se="+str, true);
  xhttp.send();
}
</script>
