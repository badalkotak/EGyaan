    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <?php
          include("dbcon.php");
          $check=mysqli_query($con,"SELECT COUNT(Batchid) FROM `Batch`");
          while($c_row=mysqli_fetch_array($check))
          {
            $count=$c_row['COUNT(Batchid)'];
          }
          
          if($count==0)
          {
            echo "<h3><strong>No Batches Added Yet!</strong><br><br></h3>";
          }
          else
          {
          ?>
...
error_reporting(0);
$i=0;
$result = mysqli_query($con,"SELECT * FROM Batch ORDER BY(`BatchName`) ASC");
...
echo "</td>";
echo "<td>";
echo "<form action=DeletePHPFiles/DelBatch.php method=post><button type=submit class=btn btn-default name=del value='$Batchid' onclick=del_confirm()>Delete</button></form>";
echo "</td>";
echo "</tr>";
}
?>
...
?>
         <div class="col-md-3">
              <div class="box box-default collapsed-box box-solid">
                ...
                <div class="box-body">
                  <form action="AddPHPFiles/AddBatch.php" role="form" method="post">
                  <div class="form-group">
                      <label>Batch Name:</label>
                      <input type="text" class="form-control" id="Batch" name="Batch" placeholder="Enter Branch"/></div>
