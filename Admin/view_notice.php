      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <?php
            echo "<li><a href=edit_notice.php?edit=$uid><i class='fa fa-edit'></i> <span>Edit Notice</span></a></li>";
            ?>
...
include("dbcon.php");
error_reporting(0);
$result= mysqli_query($con,"SELECT * FROM `NoticeBoard` WHERE `NoticeId`='$uid'");
$i=0;
