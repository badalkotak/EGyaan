    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <form action="AddPHPFiles/AddNotice.php" method="post" enctype="multipart/form-data">
<div class="form-group">
<label for="title">Title: *</label>
<input type="text" class="form-control" name="title" placeholder="Enter Title"/></div>
<div class="form-group">
<label>Notice: *</label><br>
<textarea rows="5" id="comment" name="notice" placeholder=" Notice" class="form-control"></textarea>
</div>
<div class="form-group">
...
<div class="form-group">
<div class="radio">
  <label><input type="radio" name="optnotice" value="common">Common Notice Board</label>
</div>
<?php
include("dbcon.php");
error_reporting(0);
...
echo "<div class=radio>";
  echo "<label><input type=radio name=optnotice value=branch>Branch Notice Board</label><br></div>";
  //echo "<label for=menu1>Select Branch:</label><br>";
echo "<div class='form-group'>";
echo "<select class=tb5 name=menu1>";
...
echo "</select><br>";
  ?>
<div class="checkbox">
  <label><input type="checkbox" name="urgent" value="urgent">Urgent Notice</label>
</div>
</div>
</div>
