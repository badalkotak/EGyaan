        ...
        <section class="content">
         <div class="col-md-12">
              <div class="box box-default collapsed-box box-solid">
                ...
                <div class="box-body">
                  <form action=EditPHPFiles/ChangePassword.php role="form" method="post">
            ...
            <div class="col-md-12">
              <div class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Number of rows in TimeTable</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                  </div><!-- /.box-tools -->
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form action=AddPHPFiles/AddSlots.php role="form" method="post">
                      ...
                      echo "<input type=text class=form-control name=rows value='$r' placeholder='Enter number of rows'/><br>"
                      ?>
                    <button type="submit" class="btn btn-success">SAVE</button>
                  </form>
                </div><!-- /.box-body -->
