    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            echo "<form action=EnterMarks.php?title=$title&total=$total&dot=$dot&cid=$course role=form method=post enctype=multipart/form-data>";
...
include("../dbcon.php");
              ...
              $result=mysqli_query($con,"SELECT * FROM StudentCourseRegistration WHERE CourseId='$course'");
              while($srow=mysqli_fetch_array($result))
              {
		$s_uid=$srow['StudentId'];
		$sid=mysqli_query($con,"SELECT * FROM Student WHERE StudentId='$s_uid'");
		while($row=mysqli_fetch_array($sid))
		{
                ...
                <input type=text class='form-control' id=mks name=$s_uid>
                  </div>";
                echo "</td>";
                echo "</tr>";
              }
...
{
  echo "<script>alert('Please input all fields!');window.location.href='result.php';</script>";
}
            ?>
            <button type="submit" class="btn btn-success" onclick="del_confirm()">Next</button>
          </form>
          <!-- <div id="errmsg"></div> -->
            </section><!-- /.content -->
          </div><!-- /.content-wrapper -->
...
function del_confirm() {
    var x;
    if (confirm("Do you want to continue? Please check that you have input all the fields!") == true) {
