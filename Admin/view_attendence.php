      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="student_attendence.php"><i class="fa fa-table"></i> <span>Sort by Student</span></a></li>
...
function showCourse(str) {
  ...
  xhttp.open("GET", "view_course.php?bruid="+str, true);
  xhttp.send();
}
</script>
