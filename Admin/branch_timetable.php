      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="branch_timetable_view.php"><i class="fa fa-th"></i> <span>View Timetable</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
              </aside>
...
<div id="txtHint">Select Branch to add/edit timetable..</div>
</div>
</center>
</div>
...
function showTimetable(str) {
  var xhttp;    
  if (str == "") {
    document.getElementById("txtHint").innerHTML = "Select Branch to add/edit timetable..";
    return;
  }
  ...
  xhttp.open("GET", "edit_timetable.php?branch="+str, true);
  xhttp.send();
}
</script>
