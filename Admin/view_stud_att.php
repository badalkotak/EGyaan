      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="student_attendence.php"><i class="fa fa-share"></i> <span>Select Student / Course</span></a></li>
...
echo "<select name=menu onchange=showAttendence(this.value,$cuid,$se)>"; ?>
  <option value="">Select Date..</option>
        <?php
        
        
        $date_list=mysqli_query($con,"SELECT DISTINCT Dates FROM Attendance WHERE CourseId='$cuid' AND StudentId='$se' ORDER BY(Dates) DESC");
        ...
        $total=0;
        $ab=0;
          $result2=mysqli_query($con,"SELECT Attendance FROM Attendance WHERE StudentId='$se' && CourseId='$cuid'");
          ...
          $ab=$total-$p;
          $per=($p/$total)*100;
          echo "<br><strong>Total Lectures: $total<br>Attended Lectures: $p<br>Lectures Missed: $ab<br>Percentage: $per</strong>";

        ?>
        <br><br>
        <div id="txtHint">Select Date to view attendance on a particular date...</div>
        <!-- /.col -->
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
      <!-- Main Footer -->
...
<script>
function showAttendence(str,cuid,suid) {
  var xhttp;    
  if (str == "") {
    document.getElementById("txtHint").innerHTML = "Select Date to view attendance on a particular date...";
    return;
  }
  ...
  xhttp.open("GET", "date_student_attendence.php?date="+str+"&cuid="+cuid+"&suid="+suid, true);
  xhttp.send();
}
</script>
