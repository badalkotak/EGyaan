    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="../read_Notice.php"><i class="fa fa-th"></i> <span>NoticeBoard</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
              </aside>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <form action=MakeChanges_Notice.php role="form" method="post" enctype="multipart/form-data">
<?php
error_reporting(0);
session_start();
$title=$_REQUEST['edit'];
...
include("../dbcon.php");
error_reporting(0);
$result = mysqli_query($con,"SELECT * FROM `NoticeBoard` WHERE `NoticeId`='$t'");
...
echo "<input type=text class=form-control name=title placeholder='Enter Title' value='$title'/></div>";
echo "<textarea rows=5 id=comment class=ta5 name=notice placeholder= Notice>$notice</textarea><br><br>";
echo '<div class="form-group">';
if($file!="")
{echo "<label>Current File Attached :</label>";echo "<a href=$file>Attached Notice</a><br>";}
else
{
  echo "<strong>No Attachment Added!</strong>";
}
echo '<input type="file" name="file" size="50" />';
echo '</div>';
echo "<button type=submit class=btn btn-success name=uid value=$uid >Make Changes</button>";
echo '</form>';
?>
            </div><br><br><br><!-- /.col -->
        </section><!-- /.content -->
