...
echo "</td>";
echo "<td>";
echo "<form action=EditPHPFiles/EditNotice.php method=post><button type=submit class=btn btn-success name=edit value=$uid>Edit</button></form>";
echo "</td>";
echo "<td>";
echo "<form action=DeletePHPFiles/DeleteNotice.php method=post><button type=submit class=btn btn-success name=del value=$uid onclick=del_confirm() >Delete Notice</button></form>";
echo "</td>";
echo "</tr>";
}
?>
...
<br>
            ...
            </div><a href="Notice.php"><button type="button" class="btn btn-success">Add Notice</button></a><br><br>
