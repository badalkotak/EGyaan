      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="../Admin/AdminDashboard.php"><i class="fa fa-home"></i><span>Home</span></a></li>
            <li><a href="../Admin/settings.php"><i class="fa fa-gears"></i> <span>Settings</span></a></li>
            <li><a href="../Admin/view_attendence.php"><i class="fa fa-table"></i> <span>View Attendence</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
              </aside>
...
$cname=$row['courses'];
$cuid=$row['Course_uid'];
echo "<option value=$cuid>$cname- $name</option>";
}
?>
</select><br><br>
<!-- </form> -->
