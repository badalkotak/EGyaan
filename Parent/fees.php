...
<html>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <?php
          $total_amt=0;
          $getCourses=mysqli_query($con,"SELECT * FROM StudentCourseRegistration WHERE StudentId='$sid'");
  while($gc=mysqli_fetch_array($getCourses))
  {
    ...
    echo "Student Name: $stud_usr<br>";
    echo "Total Fees: Rs. $total_amt/-<br>";
    echo "Paid Fees: Rs. $paid_amt/-<br>";
    if($pending_amt!=0)
    echo "Pending Amount: Rs. $pending_amt/-<br>";
    else
      echo "Fees Paid!";
