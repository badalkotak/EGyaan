			...
			while($batchrow=mysqli_fetch_array($getBatchName))
			{
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="myinfo.php" class="btn btn-default btn-flat">Profile</a>
                    </div>
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="myinfo.php"><image src="../Resources/icons/yearbook.png" height=100 width=88><br><h4>My Information
	      </a></center>
            </div>
            <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="Read_Notice.php"><image src="../Resources/icons/loudspeaker.png" height=100 width=88><br><h4>Notice Board
	      </a></center>
            </div>
            <div class="col-md-3 col-sm=6 col-xs-6">
            ...
            <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="view_attendance.php"><image src="../Resources/icons/hands.png" height=100 width=88><br><h4>Attendance
	      </a></center>
            </div></div><hr>
            <div class="row">
            <div class="col-md-3 col-sm=6 col-xs-6">
              <center><a href="result.php"><image src="../Resources/icons/coins.png" height=100 width=88><br><h4>Fees
	      </a></center>
            </div>
          </div><br>
          </div><hr>
